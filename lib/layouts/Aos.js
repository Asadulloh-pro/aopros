...
class Aos {
    ...
    postData({ data, moduleName, stateName, path, loading, refresh, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const { setState } = this.useAllStore(moduleName);
            if (loading)
                setState({ [loading]: true });
    ...
    putData({ data, moduleName, stateName, path, loading, refresh, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const { setState } = this.useAllStore(moduleName);
            if (loading)
                setState({ [loading]: true });
    ...
    deleteData(moduleName, path, loading, refresh) {
        return __awaiter(this, void 0, void 0, function* () {
            const { setState } = this.useAllStore(moduleName);
            if (loading)
                setState({ [loading]: true });
