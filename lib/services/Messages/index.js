...
class Messages {
    constructor(config) {
        ...
        this.logout = config === null || config === void 0 ? void 0 : config.logout;
    }
    errorHanle(error) {
        ...
        if (((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.statusCode) === 403 ||
            ((_d = (_c = error.response) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.statusCode) === 404 ||
        ...
        if (((_l = (_k = error.response) === null || _k === void 0 ? void 0 : _k.data) === null || _l === void 0 ? void 0 : _l.statusCode) === 401) {
            this.logout();
        }
