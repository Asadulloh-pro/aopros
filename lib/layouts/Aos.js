...
class Aos {
    ...
    fetchData({ params, moduleName, stateName, path, setError, ignoreError }) {
    ...
    postData({ data, moduleName, stateName, path, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const { setState } = this.useAllStore(moduleName);
            try {
    ...
    putData({ data, moduleName, stateName, path, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const { setState } = this.useAllStore(moduleName);
            try {
